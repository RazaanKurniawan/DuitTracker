      ...
      <div class="auth-card">
        ...
        <form @submit.prevent="handleLogin">
          ...
          <div class="form-group">
            ...
            <input id="password" type="password" class="form-control" v-model="password" placeholder="Masukkan password" required autocomplete="current-password" />
          </div>
  ...
  methods: {
    async handleLogin() {
      ...
      try {
        ...
        this.error = err.response?.data?.error || 'Login gagal, coba lagi.';
